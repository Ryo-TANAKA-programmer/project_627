...
lda_out <- lda(CLASS_BINARY~ Gender + AGE + Urea + Cr + HbA1c + Chol + TG + HDL + LDL + VLDL  + BMI_Category, data = Data_training) # don't need CV = TRUE
...
```{r}
qda_out <- qda(CLASS_BINARY ~ AGE , data = Data_training) # don't need CV = TRUE
