...
DC.training <- DC[training,-ycol]
DC.training.results <- DC[training,ycol] > 0.5

MV_training <- MV[training_mv,
                  -ycol]

MV_training_results <- MV[training_mv,
                          ycol] > 0.5
...
DC.test <- DC[-training,-ycol]
DC.test.results <- DC[-training,ycol] > 0.5

MV_test <- MV[-training_mv,
              -ycol]

MV_test_results <- MV[-training_mv,ycol] > 0.5
```
